...
test-pylint:
	...
	.venv/bin/pip3 install pylint secretstorage requests caldav icalendar tqdm send2trash colorama pyyaml git+https://github.com/shaarli/python-shaarli-client@master
