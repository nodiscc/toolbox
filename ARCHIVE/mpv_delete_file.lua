...
-- delete-file
-- As the name suggests this is a small script for deleting files played through mpv.
-- You can mark a file to be deleted and can unmark it if desired.
-- Once quitting mpv, the script starts the deletion process.
-- This is platform-agnostic so should work everywhere.
-- ctrl + DEL: mark/unmark file to be deleted
-- install the script to ~/.config/mpv/scripts/
